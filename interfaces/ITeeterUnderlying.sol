...
interface ITeeterUnderlying {
    ...
    function balBaseLast() external view returns (uint256);//local
    //function underlyingQTY() external view returns (uint256);
    //function underlyingValueEn() external pure returns (uint256);
    //function fundSoldQTY() external view returns (uint256);
    //function fundSoldValueEn() external view returns (uint256);
    //function fundAvaiQTY() external view returns (uint256);
    //function fundAvaiValueEn() external view returns (uint256);
    ...
    //function nvEn() external view returns (uint256);
    function initLever() external view returns (uint8);
    //function presLeverEn() external view returns (uint256);
